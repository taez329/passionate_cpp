...
Account::Account(int id, String _name, int money) // 함수의 정의
		: account_id(id), balance(money)
	{
		// name=new char[strlen(_name)+1];
		// strcpy(name, _name);
		name=_name; // 이렇게 해도 string 클래스에서 깊은 복사 정의해놔서 ㄱㅊ
	}

// 필요없어진 복사생성자, 대입연산자 정의
/*
...
/*
Account& Account::operator=(const Account& ref) // 함수의 정의, 원래 있던 객체에 대입연산자를 사용할때 깊은 복사가 진행되도록
	{
